...
export const SplashScreen: React.FC<SplashScreenProps> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] max-w-[320px] max-h-[320px] sm:w-[500px] sm:h-[500px] rounded-full bg-[#E5C07B]/15 blur-3xl pointer-events-none animate-splash-glow"
        aria-hidden="true"
      />

      {/* Rotating Traditional Sunburst / Heritage Mandala in Background - perfectly centered */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[420px] max-h-[420px] sm:w-[850px] sm:h-[850px] pointer-events-none opacity-[0.07] animate-slow-spin flex items-center justify-center"
        aria-hidden="true"
      >
        <svg
          viewBox="0 0 500 500"
