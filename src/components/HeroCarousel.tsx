                  ...
                  {slide.hasOverlay && (
                    <div className="absolute inset-0 bg-gradient-to-r from-[#24140D]/90 via-[#24140D]/60 to-transparent flex items-center p-6 sm:p-10 md:p-16 lg:p-20">
                      <div className="max-w-xl text-[#FAF2E2] space-y-4 sm:space-y-6">
                        <div>
                          <div className="badge-bounce inline-flex items-center gap-2 px-3 sm:px-3.5 py-1 rounded-full bg-[#B48448]/35 border border-[#E5C07B] backdrop-blur-md shadow-sm max-w-full">
                            <Sparkles className="w-3.5 h-3.5 text-[#E5C07B] shrink-0" />
                            <span className="text-[11px] sm:text-xs uppercase tracking-[0.14em] sm:tracking-[0.2em] font-semibold font-sans text-[#FAF2E2] truncate">
